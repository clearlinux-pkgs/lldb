...
%prep
%setup -q -n lldb-9.0.1.src
cd %{_builddir}/lldb-9.0.1.src
...
cp %{_builddir}/lldb-9.0.1.src/third_party/Python/module/pexpect-4.6/LICENSE %{buildroot}/usr/share/package-licenses/lldb/5a99e7077ee89ba92fb3f584855e8970096cd5dc
cp %{_builddir}/lldb-9.0.1.src/third_party/Python/module/ptyprocess-0.6.0/LICENSE %{buildroot}/usr/share/package-licenses/lldb/db1f866b29c6a191752c7c5924b7572cdbc47c34
cp %{_builddir}/lldb-9.0.1.src/third_party/Python/module/six/LICENSE %{buildroot}/usr/share/package-licenses/lldb/f226af67862c0c7a0e921e24672a3a1375691e3e
pushd clr-build
%make_install
popd
